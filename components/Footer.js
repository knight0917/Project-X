        ...
        <div className="flex items-end justify-between py-8 items-center sm:py-8">
          <div className="mr-16 xs:mr-32">
            <p className="inline-block py-2 text-gray-500 text-xs tracking-wider  sm:text-sm">Original articles on this site are <Link className="inline-block text-gray-500 text-xs   uppercase sm:text-sm" href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode">
              CC BY-NC-SA</Link> licensed.</p>
         
          </div>

          <ul className="flex">
            <li className="-ml-3"><Link className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://x.com/Ankitku81410904" target="_blank"
            ...
            <li><Link className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://www.youtube.com/@caelumpirata" target="_blank"
            ...
            <li><Link className="inline-block px-3 text-gray-500 text-xs tracking-wider uppercase sm:text-sm" href="https://github.com/knight0917" target="_blank"
